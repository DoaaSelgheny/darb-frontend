...
export const GUEST_URL = 'https://dev-hyyak-ehgja0c6bucpftd0.eastus-01.azurewebsites.net';

export const LOGIN_PAGE_URL = 'https://dev-hyyak-auth-dtdnbygscrgqbddj.eastus-01.azurewebsites.net/auth/login';
