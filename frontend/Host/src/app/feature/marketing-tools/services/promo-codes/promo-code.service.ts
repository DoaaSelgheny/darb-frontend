import type {
  ...
  PromoCodeCreateDto,
  PromoCodeDto,
  PromoCodeExcelDownloadDto,
  PromoCodeUpdateDto,
  PromoCodeWithNavigationPropertiesDto,
  ServiceLookUp,
} from './models';
    ...
    this.restService.request<any, PagedResultDto<PromoCodeWithNavigationPropertiesDto>>(
      {
        ...
        params: {
          ...
          consumingCountPerUserMin: input.consumingCountPerUserMin,
          consumingCountPerUserMax: input.consumingCountPerUserMax,
