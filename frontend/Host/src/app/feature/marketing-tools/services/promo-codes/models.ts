...
import { ExperienceDto } from '@proxy/experiences';
import { DiscountType } from '@proxy/shared/enums/discount-type.enum';
import { VacationHomeDto } from '@proxy/vacation-homes';
...
export interface PromoCodeWithNavigationPropertiesDto
  extends PromoCodeWithNavigationPropertiesDtoBase {}
