...
export class TermsAndConditionsComponent {
  settings = [
    {
      name: 'الاحكام والشروط',
      select: true,
      content: `<p dir="rtl"><strong>المتطلبات</strong></p>
      <p dir="rtl"><strong>للضيف:</strong></p>
      <p dir="rtl">ليتمكن الضيف من استخدام خدمات منصة حياك Hyyak بشكل كامل يتوجب عليه استكمال المعلومات المطلوبة بشكل صحيح حتى يتمكن&nbsp;مزودي الخدمات من معرفة ضيوفهم وحتى يتم الحصول على الخدمات بشكل آمن ومضمون للطرفين. حيث تتضمن المعلومات الاتي:</p>
      <ul>
      <li dir="rtl">الاسم صحيح</li>
      <li dir="rtl">عنوان بريد الكتروني صحيح</li>
      <li dir="rtl">رقم هاتف مؤكد</li>
      <li dir="rtl">الموافقة على الشروط والأحكام</li>
      <li dir="rtl">بيانات الدفع</li>
      </ul>
      <p dir="rtl">لن يتم إظهار المعلومات الحساسة الخاصة بالضيف لمزود الخدمة إلا بعد تقديم طلب الحجز، ولحماية الضيف من عمليات النصب أو الاحتيال لن يتم تحويل المبلغ المالي لحساب مزود الخدمة إلا بعد حصول الضيف على الخدمة كاملة.</p>
      <p dir="rtl"><strong>للمستضيف :</strong></p>
      <p dir="rtl">ليتمكن المضيف من استخدام المنصة يتوجب عليه استكمال المعلومات المطلوبة بشكل صحيح</p>
      <p dir="rtl">&nbsp;تتضمن المعلومات الاتي:</p>
      <ul>
      <li dir="rtl">الاسم بالكامل</li>
      <li dir="rtl">عنوان بريد الكتروني صحيح</li>
      <li dir="rtl">رقم هاتف مؤكد</li>
      <li dir="rtl">هوية صحيحة للأفراد / سجل تجاري ساري المفعول للشركات والمؤسسات</li>
      <li dir="rtl">في حال تقديم خدمات تخصصية تتطلب تصريح يرجى ارفاق تصريح \ وثيقة عمل حر \ او أي وثيقة داعمة</li>
      <li dir="rtl">الموافقة على الشروط والأحكام</li>
      <li dir="rtl">بيانات الدفع<br /><br />
      <p dir="rtl"><strong>ولضمان تقديم خدمات مميزة ومريحة وآمنة للضيوف يتوجب على المستضيف إتمام المتطلبات الأساسية والتي تتضمن الاتي:</strong></p>
      <ul>
      <li dir="rtl"><strong>الأهلية: </strong>أن يكون المستضيف أكبر من 18 سنة ويملك الحق الشرعي لإنشاء التزام قانوني ويملك كافة الوثائق الضرورية سارية المفعول.</li>
      <li dir="rtl"><strong>سرعة الاستجابة:</strong> الحفاظ على معدل استجابة عالٍ بالرد على استفسارات الحجز وطلبات الحجز في غضون 24 ساعة.</li>
      <li dir="rtl"><strong>قبول طلبات الحجز:</strong> اجعل الضيوف يشعرون بالترحاب بقبول الطلبات كلما كنت متاحًا، وضرورة الاهتمام بالتحديث المستمر بحالة الحجز.</li>
      <li dir="rtl"><strong>تجنُب الإلغاءات:</strong> نتعامل مع الإلغاءات على محمل الجد ونطلب من جميع المستضيفين تجنب إلغاء حجوزات الضيوف حيث تعتمد خطط سفرهم عليها، وفي حال حدوث أسباب تستدعي الإلغاء يتوجب إشعار الضيف بذلك في مدة لا تقل عن 72 ساعة.</li>
      <li dir="rtl"><strong>الحفاظ على تقييم عام عالٍ:</strong> يرغب الضيوف في التأكد من حصولهم على مستوى ثابت من الجودة، بغض النظر عن مكان الحجز. سوف تعطى المساكن\التجارب التي لا تُقيّم بشكل جيد مهله لمعالجة الوضع، وعند استمرار انخفاض التقييم يتم ايقافها او قد تلغى من المنصة.</li>
      <li dir="rtl"><strong>توفير الميزات الأساسية:</strong> نشجع المضيفين بشدة على توفير الميّزات الأساسية والاهتمام بالجودة والالتزام بالمعايير، لتزيد فرص إقبال الضيوف على حجز خدماتهم.</li>
      <li dir="rtl"><strong>مراعاة شروط الأمن والسلامة:</strong> يلتزم المستضيف بلوائح الامن والسلامة المعتمدة من قبل الجهات المختصة وفحصها والتأكد من جاهزيتها بشكل دوري ولا يلحق المنصة اي مطالبات نتيجة اهمال هذا الشرط.</li>
      <li dir="rtl"><strong>مراعاة الجودة والاحترافية في الخدمة المقدمة</strong>: يلتزم مزود المستضيف بأن يقدم الخدمة بأفضل الأشكال من خلال الاهتمام بكل تفاصيل الخدمة لضمان تحقيق تجربة رائعة ومميزة وفريدة للضيف. ونحن في منصة حياكHyyak نساعدك في حال احتياجك للنصائح والإرشاد لتحقيق ذلك مما يسهم في زيادة مبيعاتك وزيادة معدل حجز وشراء خدماتك عبر المنصة. فلا تتردد في التواصل مع فريقنا في أي وقت من خلال بيانات التواصل الموجودة على موقعنا الالكتروني.</li>
      <li dir="rtl"><strong>الصدق والموثوقية:</strong> يلتزم المستضيف بتوضيح كافة التفاصيل والمعلومات التي لابد للضيف معرفتها قبل وصوله والمرتبطة بالخدمة بصدق بعيداً عن التزييف أو استخدام معلومات غير صحيحة أو غير متوفرة. والتعهد بأن جميع المعلومات دقيقة وصحيحة.</li>
      <li dir="rtl"><strong>الموافقة على الشروط والأحكام والمعايير:</strong> لن يستطيع المستضيف من الوصول لكافة أدوات المنصة إلا بعد الموافقة على الشروط والأحكام والالتزام بالمعايير<br /><br /><br /><br />
      <p dir="rtl"><strong>شروط الاتفاقية</strong></p>
      <p dir="rtl">عبر وصولك واستخدام منصة حياك Hyyak فإنك توافق على قبولك من غير تعديل أو قيود أو شروط على جميع الأحكام والشروط الواردة في هذه الاتفاقية. أنت تقر وتضمن حقك القانوني للدخول في هذه الاتفاقية واستخدام الموقع وفقاً لجميع الشروط والأحكام المتواجدة هنا.</p>
      <p dir="rtl"><strong>تعديل الشروط</strong></p>
      <p dir="rtl">تعمل منصة حياك Hyyak قدر الإمكان على توفير المعلومات على الموقع الالكتروني بأكبر دقة ممكنة. مع ذلك، فإن بعض الأخطاء قد تحدث من وقت لآخر، لذا فإن منصة حياك وأي من شركائنا لا نتحمل أي مسؤولية عن أي خطأ في المعلومات التي يتضمنها موقع المنصة.</p>
      <p dir="rtl">يتضمن الموقع معلومات حول الخدمات والمنتجات التي توفرها منصة&nbsp;حياك&nbsp;وأي طرف آخر. إن المعلومات والمواد الأخرى على الموقع مقدمة بأمانة تامة. عبر استخدامك الموقع أو التطبيق فإنك توافق وتقر بأنه قد يقوم الموقع بعمل أي تحديث او تغيير أو تعديل على الشروط والأحكام أو سياسة خدمة العملاء أو أي معلومات مقدمة في أي وقت بدون سابق إنذار.</p>
      <p dir="rtl">ان الشروط والأحكام تصبح سارية المفعول بمجرد نشرها على الموقع، ولن يكون لها أي أثر رجعي على أي حجوزات تمت مسبقا من خلاله.</p>
      <p dir="rtl">يجب عليك قراءة هذه الشروط والأحكام في كل مرة تقوم بزيارة الموقع لضمان أنك على علم بكل الشروط والأحكام السابقة. وفقاً لذلك، الاستمرار باستخدامك للموقع يعتبر موافقة منك على أي تغيير في الشروط والأحكام وسياسة الاستخدام.<br /><br /></p>
      <p dir="rtl"><strong><br /><br />شروط الحجز:</strong></p>
      <ul>
      <ul>
      <li dir="rtl">كضيف بمجرد استخدامك منصة حياك Hyyak للحجز فأنت تعلن وتوافق على استخدام الموقع فقط لتحديد مدى توفر الخدمات والمنتجات المتوفرة في الموقع ولمساعدتك لجعل الحجوزات شرعية.</li>
      <li dir="rtl">استخدام خدمات الموقع فقط للحجوزات الشرعية وستقوم بإعلام كل الأشخاص الآخرين الذين سوف تقوم بالحجز بالنيابة عنهم عن الأحكام التي استخدمت بالحجز الذي قمت به، بما في ذلك جميع القواعد والقيود المطبقة عليها.</li>
      <li dir="rtl">عدم إجراء أي حجز وهمي أو تخميني أو تحسباً للطلب. من الممكن لموقع حياك أن يقوم بالإلغاء، وبدون سابق إنذار، كل الحجوزات إلى جهة أو جهات متعددة وفي نفس التاريخ.</li>
      <li dir="rtl">عندما يتم الحجز عبر منصة حياك Hyyak فإنك توافق وتلتزم كليا بالشروط المفروضة على الضيف من قبل المنصة والمستضيفين والتي تضم قوانين الإلغاء أو عدم الحضور والمحافظة على الممتلكات وكل ما يفرض عليك أثناء تلقي الخدمة. كما تقع على مسؤوليتك الشخصية التقيد بجميع شروطنا وأحكامنا الخاصة والتي تتضمن، على سبيل المثال لا الحصر، الدفع الكامل وفي الوقت المناسب لجميع المبالغ المستحقة مع الامتثال لجميع القواعد المتعلقة حول توفر الأسعار او المنتجات أو الخدمات جميع الرسوم.<br /><br /></li>
      </ul>
      </ul>
      <p dir="rtl"><strong>اخلاء المسؤولية:</strong></p>
      <p dir="rtl">موقع منصة حياك Hyyak غير مسؤول عن توفر أو مدى دقة خدمة المستضيف، ولكن إن حصل خلاف الوصف الخاص بالخدمة، يحق للعميل تقديم شكوى لإدارة المكان / التجربة. كما يحق لإدارة منصة حياك Hyyak اتخاذ الإجراء المناسب تجاه المستضيف .</p>
      <p dir="rtl">موقع منصة حياك Hyyak غير مسؤول عن أي ضرر قد يلحق بالضيف من قبل المستضيف أو أي نزاع بين الطرفين , حيث أن منصة حياك Hyyak مجرد وسيط يربط الطرفين ببعضهما ولا يقدم أي ضمانات أو تعويضات , وفي حال حدوث أي ضرر أو نزاع لا قدر الله تتعهد إدارة المنصة بتزويد المتضرر بالبيانات الخاصة بالمستضيف في حال ثبت ذلك ليتمكن الضيف من استخدامها بشكل قانوني نتيجة ما تعرض له من ضرر , ويحق لها إلغاء عضوية المستضيف .</p>
      <p dir="rtl">يستخدم موقع منصة حياك Hyyak كل الوسائل لضمان جاهزية الموقع وإتاحة كل الخدمات المرتبطة به، ولكن لا يمكن ضمان عمله بشكل مستمر أو بدون انقطاع ، حيث إن موقع منصة حياك Hyyak لا يملك أي ضمانات، سواء صريحة أو ضمنية، بخصوص محتوى الموقع، ويملك الحق بالتنازل عن جميع الضمانات وذلك وفقا لأقصى مدى متاح في القانون المعمول به.</p>
      <p dir="rtl">إن وصولك واستخدامك للبرمجيات وغيرها من المواد، أو من خلال الموقع، يقع على مسؤوليتك الشخصية.</p>
      <p dir="rtl">إن موقع منصة حياك Hyyak لا يقدم أية ضمانات حول الدقة أو الخلو من الفيروسات لمثل هذه البرامج.</p>
      <p dir="rtl">مع مراعاة القانون المعمول به، تحت أي ظرف من الظروف ان موقع منصة حياك Hyyak والجهات المرخصة لها والموردين ومقدمي الخدمات لا يتحملون أي مسؤولية مباشرة أو غير مباشرة أو عرضية أو خاصة أو تأديبية أو تعويضات تبعية أو رادعة من أي نوع (بما في ذلك على سبيل المثال لا الحصر: خسارة الأرباح أو المدخرات المفقودة أو الإيرادات، أو فقدان أو تلف البيانات أو المعلومات) التي تنشأ مع أي وسيلة اتصال باستخدام أو عدم القدرة على استخدام موقع منصة حياك Hyyak سواء على أساس الإخلال بالعقد أو الضرر أو الإهمال أو المسؤولية عن المنتجات أو غير ذلك، حتى لو تم اعلامك عن امكانية حدوث أي أضرار. هذا يتضمن أي معلومات، منتجات أو خدمات يتم الحصول عليها أو عبر أي اتصال على الموقع أو التطبيق.<br /><br /></p>
      <p dir="rtl"><strong>شروط واحكام المستضيف:</strong></p>
      <p dir="rtl"><strong>شروط الاتفاقية</strong></p>
      <p dir="rtl">كمضيف عبر وصولك واستخدام منصة حياك Hyyak فإنك توافق على قبولك، من غير تعديل أو قيود أو شروط على جميع الأحكام والشروط الواردة في هذه الاتفاقية. وتقر وتضمن حقك القانوني للدخول في هذه الاتفاقية واستخدام الموقع وفقاً لجميع الشروط والأحكام المتواجدة هنا.</p>
      <p dir="rtl"><strong>تعديل الشروط</strong></p>
      <p dir="rtl">تعمل منصة حياك Hyyak قدر الإمكان على توفير المعلومات على الموقع الالكتروني بأكبر دقة ممكنة. مع ذلك، فإن بعض الأخطاء قد تحدث من وقت لآخر، لذا فإن منصة حياك Hyyak أو أي من شركائنا لا نتحمل أي مسؤولية عن أي خطأ في المعلومات التي يتضمنها الموقع الالكتروني.</p>
      <p dir="rtl">يتضمن الموقع معلومات حول الخدمات والمنتجات التي توفرها منصة حياك Hyyak أوأي طرف آخر. إن المعلومات والمواد الأخرى على الموقع مقدمة بأمانة تامة. وعبر استخدامك الموقع او التطبيقات الخاصة بـ منصة حياك Hyyak فإنك توافق وتقر بأنه قد يقوم الموقع بعمل أي تحديث، أو تغيير، أو تعديل للشروط والأحكام، أوسياسة خدمة العملاء، أو أي معلومات مقدمة، في أي وقت بدون سابق إنذار.</p>
      <p dir="rtl">ان الشروط والأحكام تصبح سارية المفعول بمجرد نشرها على الموقع، ولن يكون لها أي أثر رجعي على أي حجوزات تمت مسبقا من خلاله.</p>
      <p dir="rtl">يجب عليك قراءة هذه الشروط والأحكام في كل مرة تقوم بزيارة الموقع لضمان أنك على علم بكل الشروط والأحكام السابقة. وفقاً لذلك، الاستمرار باستخدامك للموقع يعتبر موافقة منك على أي تغيير في الشروط والأحكام وسياسة الاستخدام.</p>
      <br />
      <p dir="rtl"><strong>شروط اضافة اماكن الاقامة او الخدمات:</strong></p>
      <p dir="rtl">بمجرد استخدامك الموقع كمضيف فأنت تعلن وتوافق على استخدامه فقط لعرض وتوفير الخدمات والمنتجات للعملاء وتلتزم بالشروط والأحكام والمعايير التي يفرضها موقع حياك.</p>
      <p dir="rtl">لمراجعة المعايير:</p>
      <ul>
      <li dir="rtl">يتحمل المضيف كافة المسؤولية عن التجربة المقدمة من ناحية السلامة والأمان.</li>
      <li dir="rtl">يتعهد المضيف بأن لديه جميع التصاريح المطلوبة نظامياً وقانونياً (إذا كانت أحد المتطلبات)</li>
      <li dir="rtl">يتعهد المضيف بوضع وصف شامل للتجربة يتضمن هذا الوصف:<br /><br /></li>
      </ul>
      <ol>
      <li dir="rtl">الموقع</li>
      <li dir="rtl">مواعيد البدء والانتهاء \ المدة</li>
      <li dir="rtl">الشروط والمتطلبات اللازمة على سبيل المثال لا الحصر (النوع، الفئة، العمر الأدنى، رسوم الإلغاء بعد تأكيد الحجز في حال وجود ذلك، الأدوات المتوفرة والغير متوفرة، الأدوات التي يجب إحضارها، العدد المتاح، معلومات الآمن والسلامة وغيرها)<br /><br /></li>
      </ol>
      <ul>
      <li dir="rtl">يتعهد مزود الخدمة بأن جميع المعلومات دقيقة وصحيحة</li>
      <li dir="rtl">يتعهد المضيف بأن يكون السعر الموجود في منصة حياك Hyyak أقل أو مساوي تماماً لسعر التجربة \ الخدمة المقدم في أي منصة أخرى شاملاً ذلك الحجز المباشر من المستضيف. وفي حال ثبوت مخالفة ذلك، يحق لإدارة منصة حياك Hyyak إيقاف العضوية ومنع الانضمام مستقبلاً، وتسقط مستحقات مقدم التجربة (إن وجدت)<br /><br /><br />
      <p dir="rtl">يتعهد المضيف بتجهيز كل متطلبات الخدمة قبل وصول الضيف بوقت كافِ، وتواجده قبل وصول الضيف في حال يتطلب الأمر ذلك</p>
      <p dir="rtl">يحق لمنصة حياك Hyyak حذف الخدمة، أو منع المضيف إذا تحقق أيا من الاتي:</p>
      <ul>
      <ol>
      <li dir="rtl">تتضمن أو تحتوي على تجاوزات قانونية أو غير ملائمة أو تتضمن ما يمس بالدين والقيم وسياسة البلد بأي شكل من الأشكال</li>
      <li dir="rtl">عدم ثبوت صحة المعلومات المدرجة من قبل / مزود الخدمة</li>
      <li dir="rtl">التلاعب في الأسعار وعدم وضع السعر المتفق عليه</li>
      <li dir="rtl">إذا تكرر عدم الحضور في الخدمات التي تتطلب حضور المستضيف بشكل شخصي أو من ينوب عنه بشكل قانوني أو شرعي</li>
      <li dir="rtl">إذا تكرر رفض طلبات الحجز على الخدمات المقدمة</li>
      <li dir="rtl">إذا تكرر التأخر في إشعار الضيف بعدم توفر الخدمة أو عدم القدرة على القيام بها لأسباب وظروف عرضية أو مفاجأة</li>
      <li dir="rtl">إذا أستمر التقييم في وضع ثابت او منخفض ولم يتحسن للأفضل</li>
      <li dir="rtl">إذا تم تكرار الحصول على تقييم سلبي من قبل الضيوف</li>
      <li dir="rtl">إذا تم تقديم شكوى ضده من قبل الضيوف وثبتت صحة الشكوى</li>
      <li dir="rtl">إذا تكرر تأخر وصوله بعد الضيوف في حال يتطلب الأمر ذلك</li>
      </ol>
      </ul>
      <br />
      <p dir="rtl">يتعهد / قدم الخدمة بالتحديث المستمر لحالة توافر الخدمات وفي حال عدم توفرها يتم توضيح ذلك بشكل مباشر وواضح</p>
      <p dir="rtl">بما يتعلق بمقدمي التجارب، قد تتم اختبار التجربة من قبل فريق المعايير والجودة وذلك لضمان صلاحية التجربة والأداء.</p>
      <p dir="rtl">يجب على صاحب المضيف المسجل في منصة حياك Hyyak الذي تمت الموافقة على عضويته تقديم التجربة بنفسه ولا يحق له توكيل أحد غيره للقيام بها إلا بشرط أن يكون التوكيل معترف به من الجهات المسؤولة وأن يكون من ينوب عنه يمتلك كافة المتطلبات ويحقق المعايير والشروط والاحكام الخاصة بتقديم الخدمات عبر منصة حياك Hyyak.</p>
      </li>
      </ul>
      </li>
      </ul>
    ...
    {
      name: 'سياسات الالغاء او تغير الحجز',
      select: false,
      content: `<p><strong>شروط الحجز</strong></p>
      <p>عندما يتم الحجز عن طريق منصة حياك &nbsp;Hyyak، فإنك تلتزم وتوافق كلياً على جميع شروط الحجز المفروضة من مكان الإقامة، والتي تضم قوانين الإلغاء وعدم الحضور، وأي شروط أخرى تفرض عليك أثناء الإقامة أو الحجز، بما في ذلك الخدمات المتاحة و/أو المنتجات التي يوفرها مكان الإقامة (من الممكن تحصيل الشروط والأحكام الإضافية الخاصة من مكان الإقامة المحدد\المضيف)</p>
      <p><strong>الوصول متأخر أو عدم الحضور</strong></p>
      ...
      <p><strong>التغيير أو إلغاء الحجز</strong></p>
      ...
      <p>في حال تغيب العميل أكثر من مره وتكرر إلغاءه للحجوزات&nbsp; يحق لإدارة منصة&nbsp;<a href="https://hyyak.com/">HYYAK</a>&nbsp;تقييد أو الغاء عضويته مستقبلاً</p>
      <p>&nbsp;</p>
      <p>سياسة الاسترجاع<strong>&nbsp;</strong><strong>:</strong></p>
      ...
      <p>مع التنويه على وجود سياسات مختلفة لدى كل مضيف ويتوجب على الضيف وضرورة اطلاع الضيف عليها قبل المطالبة بالاسترجاع.</p>
    ...
    },
    {
      ...
      <p><strong>1.3.3 </strong><strong>معلومات الجهاز</strong><strong>.&nbsp;</strong>مثل عنوان IP، ومعلومات مكونات الأجهزة والبرامج، ومعلومات الجهاز، ومعلومات أحداث الجهاز، والمعرفات الفريدة، وبيانات الأعطال، وإيصالات القراءة. يجوز لنا أن نجمع هذه المعلومات، حتى لو لم تنشئ حسابًا على Airbnb أو تسجِّل الدخول إليه.</p>
